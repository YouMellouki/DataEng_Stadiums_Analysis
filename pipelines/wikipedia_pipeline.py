...
def write_wikipedia_data(**kwargs):
    ...
    data.to_csv('abfs://football@footballdb.dfs.core.windows.net/data/' + file_name,
               storage_options={
                    'account_key': 'fFs0xQU5bSkhfDctjRI9e5w6XNXf9QdaqghRg5p8QX5/iuwu80/UuK9Wv2IfDRrTXOmhDFsPN6Z3+ASt2EzUDw=='
                }, index=False)